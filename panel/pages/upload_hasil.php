...
<body>
            ...
            <div class="row">
                <div class="col-lg-12">
					...
					$sql = mysql_query("select p.*,m.*,p.Urut as Urutan,p.XKodeKelas  as kokel,p.XTokenUjian as token from cbt_ujian p left join cbt_mapel m on m.XKodeMapel = p.XKodeMapel left join cbt_paketsoal u on u.XKodeSoal=p.XKodeSoal order by p.Urut desc");
