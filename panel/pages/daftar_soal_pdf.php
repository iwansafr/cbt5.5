      ...
      <div class="modal-header">
        ...
        <?php // echo $s['Urutan']; ?>
						...
						<p><span class="asd" class="asd">Kode Sekolah</span><span>: 
                            ...
                            <?php 
							$sqlsek = mysql_query("select * from server_sekolah");
							while($se = mysql_fetch_array($sqlsek)){
                        ...
                        <p> <span class="asd" class="asd">Mata Pelajaran</span><span>:
                            ...
                            ?>
                            <?php 
                            $sqlkelas = mysql_query("select * from cbt_mapel where NOT XKodeMapel = '$s[XKodeMapel]' order by XKodeMapel");
